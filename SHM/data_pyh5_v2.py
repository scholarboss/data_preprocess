...
width = 42
height = 42
ext_dir = 'train'  # 'train' or 'test'

save_dir = os.path.join('HDF5data_v2')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
label_lr_path = os.path.join(r'label_yuv_downsampled', ext_dir)
label_sr_path = os.path.join(r'label_yuv_oriSR', ext_dir)
input_path = os.path.join('input_yuv')
...
input_path = os.path.join('input_yuv', 'QP21')
img_list = get_name_list(input_path)
total = len(img_list)
