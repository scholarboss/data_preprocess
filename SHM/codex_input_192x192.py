...
for QP in range(29, 31):
	source_dir = 'label_yuv_downsampled_192x192'
	stream_dir = 'bit_stream_v3' + '\\QP' + str(QP)
	target_dir = 'input_yuv_192x192' + '\\QP' + str(QP)
	log_dir = 'logs'
	...
	for name in dir_list:
	    ...
	    for file in file_list:
	        ...
	        lwdt, lhgt, swdt, shgt = str(96), str(96), str(96), str(96)
